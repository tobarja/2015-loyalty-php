...
$sql = "insert into customertest (Firstname, LastName, Points, telephone, Email) 
...
if ($queryComplete){
	...
	and number $telephone, with email $email</h1><br><h2>Back to <a href='adminaddcustomer.html'>Add Customer</a>";
} else {
